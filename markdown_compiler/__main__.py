...
This will let you focus on completing just one small piece of the assignment
...
Dividing up a large project into smaller "doctestable" components is more of
an art than a science.
As you get more experience programming,
you'll slowly learn how to divide up your code this way for yourself.
This is one of the main skills that separates senior programmers from junior
programmers.

There's a handful of coding techniques in here that we haven't covered in
class and you're not expected to understand.
This is intentional.
...
WARNING:
Recall that the technology policy places no restriction on your ability to use
AI tools like ChatGPT or copilot.
Many of the simpler functions below can be solved directly with the tools.
But I strongly encourage you not to just copy/paste solutions from these tools
into the homework.
